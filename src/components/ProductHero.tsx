...
const productImages = [
  { src: "", alt: "Delora Elite IPL Device — front view" },
  { src: "", alt: "Delora Elite IPL Device — cooling head detail" },
  { src: "", alt: "Delora Elite IPL Device — smart sensor" },
  { src: "", alt: "Delora Elite IPL Device — lifestyle" },
  { src: "", alt: "Delora Elite IPL Device — in use" },
];
